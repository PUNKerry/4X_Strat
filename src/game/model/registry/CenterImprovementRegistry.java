...
public class CenterImprovementRegistry {
    ...
    public CenterImprovementRegistry() {
        ...
        register(new CenterImprovementData(
                "Митраиум", "Митраизм",
                0, 0, 0, 1, 3, 0, -1, 2,
                "Митраиум\n+3 веры, +1 культура, +2 легитимности, -1 счастье\nТребуется: Митраизм"
        ));

        register(new CenterImprovementData(
                "Исидий", "Культ Исиды",
                0, 0, 0, 1, 2, 0, 1, 0,
                "Исидий\n+2 веры, +1 культура, +1 счастье\nТребуется: Культ Исиды"
        ));

        register(new CenterImprovementData(
                "Императорский храм", "Императорский пантеон",
                0, 0, 0, 0, 2, 0, 0, 3,
                "Императорский храм\n+2 веры, +3 легитимности\nТребуется: Императорский пантеон"
        ));
        register(new CenterImprovementData(
                "Дом собраний", "Огонь",
                1, 0, 1, 0, 0, 0, 0, 0,
